...
public class Robot extends IterativeRobot {
	...
	public void autonomousInit() {
		...
		start = Side.RIGHT; // TODO: CHange this for each match!

		// To always go to switch, include 1 at the end; to always go to scale, include 2.
		objective = new PriorityObjective(autoInst.getStartSide(), fms.getNearPlate(), fms.getMidPlate(), 1);
	...
	public void teleopPeriodic() {
		...
		double newSpeed = invNum * (stick.getY() * (stick.getThrottle() - 1) / 2);
		                        /* 0 at top, 1 at bottom. */
		MAX_ACCELERATION = 0.4;//(lift.getCurrentPos() / 1.2e8 + 1.0) * 0.4 + 0.2;
		...
		drive.set(newSpeed, stick.getX() * 0.3);
